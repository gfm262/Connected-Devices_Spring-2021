/* This is re-typed and (very slightly) modified (code) and copied (comments) using the code example found at:
...
void loop() {
  ...
  int sensorReadingMapped = map(sensorReading, 10, 1023, 0, 100);
