/* This was re-typed (code) and copied (comments) using the code example found at:
 *  https://github.com/tigoe/display-examples/blob/main/OLED_Examples/SSD1306_QRCode_Test/SSD1306_QRCode_Test.ino
 */
...
*/
 ...
 const int SCREEN_HEIGHT = 32; //OLDE DISPLAY HEIGHT, in pixels
 const int OLED_RESET = 0; // reset pin for display (0 or -1 if no reset pin)
 //colors for a monocrome siplay:
